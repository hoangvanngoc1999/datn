<div style="width:600px; margin:0 auto;">
    <div style="text-align:center;">
        ...
        <p>Bạn đã đặt hàng tại hệ thống của chúng tôi, vui lòng kiểm tra lại thông tin đơn hàng và nhấn vào nút xác nhận
            đơn
            hàng</p>
        <p>
            <a href="{{route('order.accept', ['order' => $order->id, 'token'=>$order->token])}}"
